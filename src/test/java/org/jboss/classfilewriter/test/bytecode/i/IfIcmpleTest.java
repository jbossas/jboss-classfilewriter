...
public class IfIcmpleTest {
    ...
    public void testIfAcmple() {
        ...
        Assert.assertEquals(0, (int) mt.invoke(10, 11));
        Assert.assertEquals(10, (int) mt.invoke(101, 11));
    }
}
